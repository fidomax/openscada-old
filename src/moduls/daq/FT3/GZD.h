...
#define vs_06        6
	...
	public:
	    SKAZDchannel(uint8_t iid, DA* owner) : da(owner),
		    ...
		    TUOpen(TSYS::strMess("TUopen_%d", id + 1).c_str(), TSYS::strMess(_("TU open %d"), id + 1).c_str()),
		    TUClose(TSYS::strMess("TUclose_%d", id + 1).c_str(), TSYS::strMess(_("TU close %d"), id + 1).c_str()),
		    ...
		    TimeOpen(TSYS::strMess("timeOpen_%d", id + 1).c_str(), TSYS::strMess(_("Open time %d"), id + 1).c_str()),
		    TimeClose(TSYS::strMess("timeClose_%d", id + 1).c_str(), TSYS::strMess(_("Close time %d"), id + 1).c_str()),
		    ...
		    TCOpen(TSYS::strMess("tcOpen_%d", id + 1).c_str(), TSYS::strMess(_("Open TC %d"), id + 1).c_str()),
		    TCClose(TSYS::strMess("tcClose_%d", id + 1).c_str(), TSYS::strMess(_("Close TC %d"), id + 1).c_str()),
		    TCMode(TSYS::strMess("tcMode_%d", id + 1).c_str(), TSYS::strMess(_("Mode TC %d"), id + 1).c_str()),
		    TCOpenErr(TSYS::strMess("tcOpenErr_%d", id + 1).c_str(), TSYS::strMess(_("Open error TC %d"), id + 1).c_str()),
		    TCCloseErr(TSYS::strMess("tcCloseErr_%d", id + 1).c_str(), TSYS::strMess(_("Close error TC %d"), id + 1).c_str())
	    {
	    }
	    DA* da;
	    uint8_t id;
