...
B_UTHET::B_UTHET( TMdPrm *prm, uint16_t id, uint16_t n, bool has_params) : DA(prm), ID(id<<12), count_n(n), with_params(has_params)//, numReg(0)

{
	TFld * fld;
	mPrm->p_el.fldAdd(fld = new TFld("state",_("State"),TFld::Integer,TFld::NoWrite) );
	fld->setReserve("0:0");
	//mPrm->p_el.fldAdd(fld = new TFld("expense",_("Expense"),TFld::Real,TFld::NoWrite));
	//fld->setReserve("0:1");
	//mPrm->p_el.fldAdd(fld = new TFld("quantity",_("Quantity point"),TFld::Integer,TFld::NoWrite));
	//fld->setReserve("0:2");
	...
	for (int i = 1; i <= count_n; i++)	{
		...
		if (with_params){
		    ...
		    fld->setReserve(TSYS::strMess("%d:5",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("sensor1_%d",i).c_str(),TSYS::strMess(_("Sensor 1 %d"),i).c_str(),TFld::Integer,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:6",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("sensor2_%d",i).c_str(),TSYS::strMess(_("Sensor 2 %d"),i).c_str(),TFld::Integer,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:6",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("sensorT_%d",i).c_str(),TSYS::strMess(_("Sensor T %d"),i).c_str(),TFld::Integer,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:6",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("sensorP_%d",i).c_str(),TSYS::strMess(_("Sensor P %d"),i).c_str(),TFld::Integer,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:6",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("serviceQ_%d",i).c_str(),TSYS::strMess(_("Service flow %d"),i).c_str(),TFld::Real,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:7",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("hour_%d",i).c_str(),TSYS::strMess(_("Contract hour %d"),i).c_str(),TFld::Integer,TVal::DirWrite));
		    ...
		    //fld->setReserve(TSYS::strMess("%d:12",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("period_date_%d",i).c_str(),TSYS::strMess(_("Period %d"),i).c_str(),TFld::Integer,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:12",i));	
		    ...
		    fld->setReserve(TSYS::strMess("%d:13",i));	
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("periodQ_%d",i).c_str(),TSYS::strMess(_("Periodicly Q %d"),i).c_str(),TFld::Real,TFld::NoWrite));
			...
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("asperity_%d",i).c_str(),TSYS::strMess(_("Equivalence asperity %d"),i).c_str(),TFld::Real,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:16",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("concentrN_%d",i).c_str(),TSYS::strMess(_("N concentration %d"),i).c_str(),TFld::Real,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:17",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("concentrCO_%d",i).c_str(),TSYS::strMess(_("CO concentration %d"),i).c_str(),TFld::Real,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:18",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("diameterM_%d",i).c_str(),TSYS::strMess(_("Membrane diameter %d"),i).c_str(),TFld::Real,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:19",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("factorM_%d",i).c_str(),TSYS::strMess(_("Membrane factor %d"),i).c_str(),TFld::Real,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:20",i));		
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("diameterP_%d",i).c_str(),TSYS::strMess(_("Pipe diameter %d"),i).c_str(),TFld::Real,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:21",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("factorC_%d",i).c_str(),TSYS::strMess(_("Pipe factor %d"),i).c_str(),TFld::Real,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:22",i));	
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("methodM_%d",i).c_str(),TSYS::strMess(_("Measure method %d"),i).c_str(),TFld::Integer,TVal::DirWrite));
			...
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("radius_%d",i).c_str(),TSYS::strMess(_("Membrane radius %d"),i).c_str(),TFld::Real,TVal::DirWrite));
		    fld->setReserve(TSYS::strMess("%d:26",i));
			mPrm->p_el.fldAdd(fld = new TFld(TSYS::strMess("pressure_%d",i).c_str(),TSYS::strMess(_("Atmospheric pressure %d"),i).c_str(),TFld::Real,TVal::DirWrite));
...
uint16_t B_UTHET::Task(uint16_t uc)
{
    tagMsg Msg;
	uint16_t rc = 0;
	switch (uc){
...
/*							*((uint16_t *)(Msg.D + 48))	= ID|( i<<6 )|( 25); //Тестовый расход
							*((uint16_t *)(Msg.D + 50))	= ID|( i<<6 )|( 26); //Средний радиус закругления кромки диафрагмы
							*((uint16_t *)(Msg.D + 52))	= ID|( i<<6 )|( 27); //Атмосферное давление
							*((uint16_t *)(Msg.D + 54))	= ID|( i<<6 )|( 28); //dP, t, P, E*/
							if (mPrm->owner().Transact(&Msg)) {
								if (Msg.C == GOOD3) {
...
uint16_t B_UTHET::HandleEvent(uint8_t * D)
{
...
uint16_t B_UTHET::setVal(TVal &val)
{
	int off = 0;
	...
	case 2: case 8:case 23:
		...
		break;
	case 3:case 7:case 9:case 10:case 14:case 15:case 16:case 17:case 18:case 19:case 20:case 21:case 22:case 25:case 26:case 27:
		Msg.L = 9;
		Msg.C = SetData;
		Msg.D[0] = addr & 0xFF;
		Msg.D[1] = (addr >> 8) & 0xFF;
