...
void KA_TANK::SKATANKchannel::UpdateParam(uint16_t ID, uint8_t cl)
{
    ...
    if (tmp[0].w != TCSens1.vl || tmp[1].w != TCSens1Not.vl || tmp[2].w != TCSens2.vl || tmp[3].w != TCSens2Not.vl || tmp[4].w != TULight.vl || tmp[5].w != TUSound.vl ||
	tmp[6].w != TURlOff.vl || tmp[7].w != TimeDelay.vl || tmp[8].w != TimeFalseAlarm.vl) {
	TCSens1.s = 0;
	...
	uint8_t E[19] =
	{ 0,		 tmp[0].b[0], tmp[0].b[1], tmp[1].b[0], tmp[1].b[1], tmp[2].b[0], tmp[2].b[1], tmp[3].b[0], tmp[3].b[1], tmp[4].b[0], tmp[4].b[1], tmp[5].b[0], tmp[5].b[1],
	  tmp[6].b[0], tmp[6].b[1], tmp[7].b[0], tmp[7].b[1], tmp[8].b[0], tmp[8].b[1] };
